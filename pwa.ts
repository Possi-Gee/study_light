 ...
 * @param {NextConfig} nextConfig - The original Next.js configuration.
 * @returns {NextConfig} The PWA-enabled Next.js configuration.
 */
export default (nextConfig: NextConfig): NextConfig => withPWA(nextConfig);
